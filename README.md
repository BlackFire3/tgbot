...
- В связи с ограничениями **API ЦБ РФ** получение исторических данных о курсе валют невозможно. Курс обновляется ежедневно, сохраняется в **SQLite** и хранится 30 дней.
